...
from Sophia.Best_Of_Sophia.pluginhelpers import convert_to_image
...
async def boycott_kangs(client, message):
    ...
    foreground = Image.open("./Sophia/etc/x-cross.png").convert("RGBA")
    x, y = foreground.size
...
Speacial Thanks @miss_musicybot"""
