...
__help__ = """
This module is dedicated towards utlising Sophia's localization feature! You can also <a href='https://crowdin.com/project/sophiax'>contribute</a> for improving localization in Sophia!
<b>Available commands:</b>
- /lang: Shows a list of avaible languages
- /lang (language codename): Sets a language

<b>Example:</b> <code>/lang</code>
Sophia will send you bunch of inline buttons where you can select your prefered language interatively without any hassles!
"""
