...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ Add To Your Group ➕️", url="t.me/SophiaSLBot?startgroup=true"),
    ],
    [
    ...
    [
        InlineKeyboardButton(text="Updates", url=f"https://t.me/SophiaX_Updates"),
        InlineKeyboardButton(
            text="Developer", url=f"https://t.me/SophiaX_Updates"
        ),
    ],
    [
...
DONATE_STRING = """Hey, glad to hear you want to donate!
 You can support the project Of []() \
